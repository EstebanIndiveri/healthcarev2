    ...
    return ( 
        ...
        {/* className="animate__animated animate__fadeInLeft animate__delay-3s " */}
            <Col>
                ...
                <div className="" style={{top:'-250px',left:'9.2rem' ,height: '340px',width: '290px',backgroundColor:'white', boxShadow:'0px 7px 26px 5px rgba(0, 0, 0, 0.20)',position:'relative', zIndex:'999',borderRadius:'20px',}}>
                    <div style={{background:'red',boxShadow:'0px 7px 26px 5px rgba(0, 0, 0, 0.20)' ,borderRadius:'100%', height:'50px',width:'50px',top:'20px',left:'30px',position:'relative',display:'flex'}}>
                        <div
