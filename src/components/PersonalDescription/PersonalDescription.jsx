                ...
                <Col>
                    ...
                    css={css`
                        ...
                        <h2 className="text-center text-underline">
                            ...
                            <p className="mt-4"><Span>En pocas palabras, la labor del pediatra consiste en “cuidar al niño sano, evaluar su salud y la cuestión nutricional para que cubra sus requerimientos, además de monitorear su desarrollo psicológico y social”</Span>
                            </p>
                             </p>
                    </div>
                </Col>
